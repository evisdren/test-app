    ...
    <div className="flex min-h-screen flex-col bg-zinc-50 py-8 font-sans dark:bg-zinc-900">
      <header className="px-6">
        <div className="mb-6 flex items-center justify-center gap-4">
          ...
          <button
            onClick={toggleTheme}
            className="rounded-lg border border-zinc-300 bg-white p-2 text-zinc-600 transition-colors hover:bg-zinc-100 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
